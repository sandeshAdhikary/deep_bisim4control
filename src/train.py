...
from envs.reacher_levelset.reacher_levelset import ReacherLevelSet
from envs.reacher_levelset.callbacks import ReacherLevelSetEvalCallback
...
def run_train(args=None):
    ...
    if args.domain_name == 'carla':
        ...
        domain_callback = ReacherEvalCallback()
    elif args.domain_name == 'reacher_grid':
        size = 20
        env = make_gridworld(
            domain_name=args.domain_name,
            task_name=args.task_name,
