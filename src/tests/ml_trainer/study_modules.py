...
class SimpleDataset(Dataset):
    ...
    DATA_PATHS = {
        'train':'/project/src/tests/ml_trainer/data/valid_data.npy',
        'valid':'/project/src/tests/ml_trainer/data//valid_data.npy',
        'test':'/project/src/tests/ml_trainer/data/test_data.npy'
    }
